...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{Nhập môn Đảm bảo và An Ninh Thông tin}
...
\begin{titlepage}
    ...
    \begin{center}
        ...
        \textbf{\Large Môn: Nhập môn Đảm bảo và An ninh Thông tin} \\
...
\begin{figure}[h]
    ...
    \begin{minipage}{0.25\textwidth}
        ...
        \begin{tikzpicture}
            ...
            \node at (1.5,2) {\includegraphics[width=3cm, keepaspectratio]{asset/download (1).jpeg}};
        \end{tikzpicture}
        \vspace{0.3cm}
    ...
    \begin{minipage}{0.25\textwidth}
        ...
        \begin{tikzpicture}
            \draw[thick] (0,0) rectangle (3,4);
            \clip (0,0) rectangle (3,4);
            \node at (1.5,2) {\includegraphics[width=3cm, keepaspectratio]{asset/download.jpeg}};
        \end{tikzpicture}
        \vspace{0.3cm}
...
Lời đầu tiên, chúng em xin gửi lời cảm ơn chân thành và sâu sắc nhất đến TS. Nguyễn Tấn Cầm, giảng viên hướng dẫn môn học Nhập môn Đảm bảo An toàn Thông tin. Thầy đã tận tình truyền đạt những kiến thức nền tảng quý báu, định hướng tư duy nghiên cứu và tạo mọi điều kiện thuận lợi để chúng em có thể tiếp cận với đề tài đầy thách thức nhưng cũng rất thú vị về \textit{Federated Learning} sử dụng \textit{Flower framework}.
...
\newpage
\input{chapters/chapter4_experiments.tex}
\newpage
