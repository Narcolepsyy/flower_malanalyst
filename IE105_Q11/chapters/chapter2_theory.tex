...
Thuật toán nền tảng được sử dụng rộng rãi nhất trong FL và cũng là chiến lược mặc định của Flower là Federated Averaging (FedAvg). Quy trình hoạt động của FedAvg bao gồm 4 bước lặp lại trong mỗi vòng huấn luyện (communication round) $t$:
...
Khác với hai phương pháp trên thực hiện trên từng tọa độ (coordinate-wise), Krum lựa chọn một cập nhật mô hình từ một client thực tế mà "giống" với số đông nhất dựa trên khoảng cách Euclidean.
