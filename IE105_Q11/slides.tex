...
\subtitle{Báo cáo Đồ án môn học IE207 Đồ án}
\author[T.T. Khải \& T.H. Đông]{\texorpdfstring{Trần Tấn Khải - 23520680 \and Trần Hải Đông - 23520300 \\ \vspace{0.2cm} \small GVHD: PGS. Nguyễn Tấn Cầm}{Trần Tấn Khải \& Trần Hải Đông}}
\institute[UIT]{Trường Đại học Công nghệ Thông tin - ĐHQG TP.HCM}
\date{\today}
\titlegraphic{\includegraphics[width=1.5cm]{asset/uit_logo.png}}
...
\begin{frame}
    ...
    \vspace{1cm}
    \normalsize Khoa Mạng máy tính và Truyền thông - UIT
\end{frame}
